...
HD_PWD='E:/User/Desktop/pipeline-cpu/pipeline_cpu_mips/pipeline_cpu_mips.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log min_sopc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source min_sopc.tcl
