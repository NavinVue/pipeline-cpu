...
HD_PWD='E:/User/Desktop/final_version/pipeline-cpu/pipeline_cpu_mips/pipeline_cpu_mips.runs/data_ram_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log data_ram_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source data_ram_ip.tcl
