...
HD_PWD='E:/User/Desktop/pipeline-cpu/pipeline_cpu/pipeline_cpu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log min_sopc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source min_sopc.tcl -notrace
